...
Once all the user input is complete in the Python portion, copy over the basketball_data.txt and user_data.txt files to the corresponding MATLAB folder. 
